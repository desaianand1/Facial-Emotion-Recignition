...
options = trainingOptions('sgdm', 'MiniBatchSize', 35, ...
    'MaxEpochs', 4, 'InitialLearnRate', 1e-3, 'ValidationData', {validationVector, validationLabels}, ...
...
%% Testing
[Ypred, scores] = classify(iterativeTrainings(10), validationVector);
